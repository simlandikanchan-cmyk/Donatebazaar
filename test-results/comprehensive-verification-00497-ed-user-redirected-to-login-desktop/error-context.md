...
- Name: comprehensive-verification.spec.ts >> Comprehensive Independent Verification >> Authorization / IDOR >> unauthenticated user redirected to login
- Location: tests\browser\comprehensive-verification.spec.ts:175:5
