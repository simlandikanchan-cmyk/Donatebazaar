...
- Name: comprehensive-verification.spec.ts >> Comprehensive Independent Verification >> Authorization / IDOR >> creator cannot access admin dashboard
- Location: tests\browser\comprehensive-verification.spec.ts:188:5
    ...
    - generic [ref=f2e3]:
      ...
      - generic [ref=f2e16]:
        ...
        - button "Notifications" [ref=f2e26] [cursor=pointer]:
          - generic [ref=f2e27]: "0"
        - button "Account menu for kanchan simlandi" [ref=f2e33] [cursor=pointer]:
          - img "kanchan simlandi" [ref=f2e34]
  - main [ref=f2e37]:
    - generic [ref=f2e40]:
