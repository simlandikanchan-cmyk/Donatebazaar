...
Every component file, its exported classes, and where they're used. Exported means defined in the component — many classes are consumed across multiple admin pages.
