...
var discardLeave=document.querySelector('#discardModal a.btn-modal-delete');
  if(discardLeave)discardLeave.addEventListener('click',function(){__leaving=true;});

/* Unsaved-changes guard */
window.addEventListener('beforeunload',function(e){if(formDirty&&!submitting&&!__leaving){e.preventDefault();e.returnValue='';}});
