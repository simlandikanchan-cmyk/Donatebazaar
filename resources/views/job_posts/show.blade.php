...
<section class="job-hero">
    <div class="job-hero-inner">
        ...
        <div class="hero-actions">
            <x-button variant="primary" href="#apply-form">
                Apply Now
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5">
    ...
    <main>
        ...
        <div class="share-section">
            ...
            <div class="share-btns">
                ...
                <x-button variant="secondary" href="https://www.linkedin.com/sharing/share-offsite/?url={{ urlencode(request()->url()) }}" target="_blank" rel="noopener">
                    <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <x-button variant="secondary" href="https://twitter.com/intent/tweet?text={{ urlencode('Hiring: '.$jobPost->title.' at DonateBazaar') }}&url={{ urlencode(request()->url()) }}" target="_blank" rel="noopener">
                    <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
