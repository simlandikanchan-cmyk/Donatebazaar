            ...
            <tr>
              ...
              <td>
                <div class="act-btns">
                  ...
                  @if($app->cv_path)
                  <x-button variant="secondary" href="{{ route('admin.job_post_applications.downloadCv', $app) }}" target="_blank" class="ab-download">
  ...
  <div class="side-stack">
    ...
    <div class="side-card">
      ...
      <div class="btn-stack">
        ...
        <x-button variant="secondary" href="{{ route('admin.job_posts.create') }}">
