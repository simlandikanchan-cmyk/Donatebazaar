...
<div class="modal-overlay" id="deleteModal">
  <div class="modal">
    ...
    <div class="modal-btns">
      <x-button variant="secondary" type="button" class="btn-modal-cancel">
...
<div class="modal-overlay" id="discardModal">
  <div class="modal">
    ...
    <div class="modal-btns">
      ...
      <x-button variant="secondary" href="{{ route('admin.job_posts.index') }}" class="btn-modal-delete">
...
<div class="page-hdr">
  ...
  <div class="page-hdr-right">
    ...
    <x-button variant="secondary" href="{{ route('admin.job_posts.index') }}"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M10 19l-7-7m0 0l7-7m-7 7h18"/></svg>Back to Listings</x-button>
  </div>
</div>
      ...
      <div class="card" style="animation-delay:.05s">
        ...
        <div class="field">
          ...
          <div class="slug-preview" id="slugPreview">
            ...
            <x-button variant="primary" type="button" class="slug-lock-btn">Manual</x-button>
          </div>
