...
<div class="detail-card">
  ...
  <form method="POST" action="{{ route('admin.applications.approve', $application->id) }}" id="adminNotesForm">
    ...
    <div style="display:flex;gap:8px;flex-wrap:wrap;">
      <x-button variant="secondary" type="button" class="c-btn">
...
<div class="actions-card">
  ...
  <div class="actions-right">
    <x-button variant="secondary" href="{{ route('admin.applications') }}" class="c-btn">
    ...
    @if($application->status === 'pending' || $application->status === 'under_review')
      ...
      <x-button variant="destructive" type="button" class="c-btn" onclick="openReject({{ $application->id }})">
