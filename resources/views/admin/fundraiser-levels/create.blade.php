...
<div class="hero">
  <div class="hero-left">
    ...
    <div class="hero-name">Add a New Level</div>
    <div class="hero-sub">Configure a new progression tier for fundraisers on the platform.</div>
  </div>
    ...
    <div class="card-body">
      ...
      <div class="grid-2">
        ...
        <div class="field">
          ...
          <div class="color-row">
            <input type="color" id="badge_color" name="badge_color" value="{{ old('badge_color','#6366f1') }}" aria-label="Pick badge color">
            <span class="color-hex">{{ old('badge_color','#6366f1') }}</span>
          </div>
          <p class="f-hint">Select the hex color used for the level badge in the UI.</p>
