...
.ab-view{display:inline-flex;align-items:center;gap:5px;height:32px;padding:0 12px;border-radius:var(--r-sm);font-size:12px;font-weight:500;text-decoration:none;transition:all var(--ease);background:var(--a-lt);color:var(--a);border:1px solid rgba(37,99,235,.2);}
.ab-view:hover{background:var(--a);color:#fff;box-shadow:0 4px 14px rgba(37,99,235,.35);}
.ab-view svg{width:13px;height:13px;}
.cmp-edit{display:inline-flex;align-items:center;gap:5px;height:32px;padding:0 12px;border-radius:var(--r-sm);font-size:12px;font-weight:500;text-decoration:none;transition:all var(--ease);background:var(--a-lt);color:var(--a);border:1px solid rgba(37,99,235,.2);}
