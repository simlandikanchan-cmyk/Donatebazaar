@push('page_css')
@vite('resources/css/admin/entries/campaigns-index.css')
@endpush
...
<div class="modal-overlay" id="discardModal">
    <div class="modal">
        ...
        <div class="modal-actions">
            <button type="button" class="btn btn-secondary action-btn btn-ghost" data-action="close-discard">Keep Editing</button>
                        ...
                        <div class="cover-upload-zone" id="coverZone">
                            ...
                            <div class="cover-preview-wrap" id="coverPreviewWrap"
                                ...
                                <div class="cover-preview-overlay">
                                    ...
                                    <button type="button" class="btn btn-red cover-preview-btn cover-preview-btn-remove" data-action="remove-cover">
...
{{-- Page data for campaign-edit.js --}}
<script type="application/json" id="campaignEditData">
@php
    $campaignEditData = [
        'showUrl' => route('admin.campaign.show', $campaign->id),
        'success' => session('success'),
        'error'   => session('error'),
    ];
@endphp
@json($campaignEditData)
</script>
@endsection
...
@push('page_styles')
@vite('resources/css/admin/pages/campaign-edit.css')
@endpush
