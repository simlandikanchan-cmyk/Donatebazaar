...
.view-btn{display:inline-flex;align-items:center;gap:5px;padding:6px 12px;background:var(--surface);border:1px solid var(--border2);border-radius:var(--r-sm);font-size:12px;font-weight:500;color:var(--text2);text-decoration:none;transition:all var(--ease);}
.view-btn:hover{border-color:var(--a);color:var(--a);background:var(--a-lt);}
...
@media(max-width:380px){.toolbar-right{width:100%}.toolbar-right .export-btn{flex:1;justify-content:center}}
>>>>>>> origin/master
...
<form id="filterForm" method="GET" action="{{ route('admin.organizations.index') }}" style="margin-bottom:0;">
  <div class="toolbar">
    ...
    <div class="toolbar-right">
      <a href="{{ route('admin.organizations.create') }}" class="export-btn" style="border-color:var(--a);color:var(--a);background:var(--a-lt);">
      ...
      <tbody>
        @forelse($organizations as $org)
          <tr>
            ...
            <td>
              <a class="view-btn" href="{{ route('admin.applications.show', $org->id) }}">
