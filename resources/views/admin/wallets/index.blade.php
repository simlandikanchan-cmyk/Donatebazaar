          ...
          <tr data-owner-type="{{ $filterAttr }}">
            ...
            <td data-label="Actions" style="text-align:right;">
              <div class="action-btns">
                ...
                <form method="POST" action="{{ route('admin.wallets.destroy', $w) }}" style="display:inline-flex;gap:4px;align-items:center;" onsubmit="return confirm('Delete this wallet? This cannot be undone.');">
                  @csrf @method('DELETE')
