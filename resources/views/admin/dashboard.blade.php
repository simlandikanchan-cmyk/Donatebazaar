...
<div class="stats-grid">
  ...
  <div class="stat">
    ...
    <div class="stat-body"><div class="stat-lbl">Wallet Balance</div><div class="stat-val sv-teal">₹{{ number_format($totalWalletBalance) }}</div><div class="stat-foot"><a href="{{ route('admin.wallets.index') }}">Across all wallets →</a></div></div>
  </div>
  <div class="stat">
...
window.__DASHBOARD_DATA__ = {
  ...
  chartTotal: @json($chartTotal),
  chartActive: @json($chartActive),
  revLabels: @json($revLabels),
  revData: @json($revData),
  topCampLabels: @json($topCampLabels),
  topCampValues: @json($topCampValues),
