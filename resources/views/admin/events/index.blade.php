          ...
          <tr data-id="{{ $event->id }}"
            ...
            <td>
              <div class="act-wrap">
                ...
                <form action="{{ route('admin.events.destroy', $event->id) }}" method="POST" style="display:inline;" data-confirm="Delete this event? This cannot be undone.">
                  @csrf @method('DELETE')
  ...
  @forelse($events as $event)
    ...
    <div class="ev-card"
      ...
      <div class="ev-card-actions">
        ...
        @endif
        <form class="act-form" method="POST" action="{{ route('admin.events.destroy', $event->id) }}" data-confirm="Delete this event? This cannot be undone.">
          @csrf @method('DELETE')
