...
@media(max-width:480px){.page-hdr{padding:0 0 6px}.page-name{font-size:17px}.page-av{width:44px;height:44px;font-size:17px;border-radius:12px}.info-grid{grid-template-columns:1fr}.info-item{padding:12px 10px}.info-item:nth-child(2n){border-right:1px solid var(--border)}.info-item:nth-child(3n){border-right:none}.info-item:nth-child(2n){border-right:none}.info-item:nth-last-child(-n+3){border-bottom:none}.info-item:nth-last-child(-n+2){border-bottom:1px solid var(--border)}.info-label{font-size:9px}.info-val{font-size:13px}.form-row{grid-template-columns:1fr;gap:12px}.page-hdr-right{gap:6px}.page-hdr-right .btn{font-size:12px;padding:9px 14px;flex:1;justify-content:center}.status-pill{font-size:10px;padding:4px 10px}}
@media(max-width:380px){.page-hdr{gap:10px}.page-name{font-size:15px}.page-meta{font-size:10px}.page-av{width:38px;height:38px;font-size:14px;border-radius:10px}.info-label{font-size:8px}.info-val{font-size:12px}.info-item{padding:10px 8px}.form-card-head h4{font-size:12px}.form-card{padding:14px 12px}.form-grid{gap:10px}.submit-btn{font-size:12px;height:36px;padding:0 16px}.back-btn{font-size:11px;height:32px;padding:0 10px}.page-hdr-right{flex-direction:column;width:100%}.page-hdr-right>*{width:100%;justify-content:center}}
</style>
@endpush
@section('content')
{{-- BACK --}}
