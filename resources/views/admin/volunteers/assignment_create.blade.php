...
@section('topbar_left')
  <a href="{{ route('admin.volunteer_assignments.index') }}" class="back-btn">
...
<form method="POST" action="{{ $isEdit ? route('admin.volunteer_assignments.update', $assignment->id) : route('admin.volunteer_assignments.store') }}">
  ...
  <div style="margin-top:18px;display:flex;gap:10px;">
    ...
    <a href="{{ route('admin.volunteer_assignments.index') }}" class="back-btn" style="text-decoration:none;">Cancel</a>
  </div>
</form>
@endsection
