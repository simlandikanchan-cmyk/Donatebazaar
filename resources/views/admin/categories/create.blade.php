...
<title>Create Category — DonateBazaar Admin</title>
  ...
  <header class="topbar">
    <div style="display:flex;align-items:center;gap:10px;">
      ...
      <div class="tb-left">
        ...
        <p>Add a new campaign category to the platform</p>
      </div>
    </div>
    <div class="tb-right">
      ...
      <div>
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            @php $icons=['fa-heart'=>'Heart','fa-book'=>'Book','fa-paw'=>'Paw','fa-user'=>'Person','fa-hand-holding-heart'=>'Giving','fa-stethoscope'=>'Medical','fa-graduation-cap'=>'Education','fa-globe'=>'Global','fa-child'=>'Child','fa-hands-helping'=>'Helping','fa-tree'=>'Nature','fa-home'=>'Housing','fa-water'=>'Water','fa-fire'=>'Emergency','fa-church'=>'Religion','fa-bread-slice'=>'Food','fa-wheelchair'=>'Disability','fa-music'=>'Arts']; @endphp
            <div class="icon-grid">
