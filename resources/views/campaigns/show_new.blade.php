...
/* ══ NEW: Donations list (detailed card) ══ */
.donations-list { display: flex; flex-direction: column; gap: 10px; }
.donation-row { display: flex; align-items: center; gap: 12px; padding: 12px 14px; background: var(--surface2); border: 1px solid var(--border); border-radius: var(--radius-sm); transition: border-color var(--transition), transform var(--transition); }
.donation-row:hover { border-color: rgba(99,102,241,.2); transform: translateX(2px); }
.donation-avatar { width: 38px; height: 38px; border-radius: 10px; background: linear-gradient(135deg, var(--accent), var(--accent2)); color: #fff; font-size: 14px; font-weight: 700; display: flex; align-items: center; justify-content: center; flex-shrink: 0; }
.donation-avatar.anon { background: var(--surface); border: 1px solid var(--border2); color: var(--text3); }
.donation-main { flex: 1; min-width: 0; }
.donation-name-row { display: flex; align-items: baseline; justify-content: space-between; gap: 10px; }
.donation-name { font-size: 13px; font-weight: 700; color: var(--text); white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
.donation-amt { font-size: 14px; font-weight: 700; color: var(--accent); font-family: var(--font-mono); white-space: nowrap; flex-shrink: 0; }
.donation-meta-row { display: flex; align-items: center; gap: 8px; margin-top: 2px; }
.donation-date { font-size: 10.5px; color: var(--text3); font-family: var(--font-mono); }
.donation-badge { font-size: 9px; font-weight: 700; padding: 1px 7px; border-radius: 100px; text-transform: uppercase; letter-spacing: .05em; font-family: var(--font-mono); }
.donation-badge.completed { background: rgba(16,185,129,.12); color: #10b981; }
.donation-badge.pending   { background: rgba(245,158,11,.12); color: #f59e0b; }
.donation-badge.failed    { background: rgba(239,68,68,.12); color: #ef4444; }
.donation-msg { font-size: 11.5px; color: var(--text2); margin-top: 6px; padding-top: 6px; border-top: 1px solid var(--border); line-height: 1.5; font-style: italic; }

.donations-summary-bar { display: grid; grid-template-columns: repeat(3, 1fr); gap: 10px; margin-bottom: 16px; }
.donations-summary-stat { text-align: center; padding: 12px 8px; background: var(--surface2); border: 1px solid var(--border); border-radius: var(--radius-sm); }
.donations-summary-val { font-size: 17px; font-weight: 700; color: var(--text); font-family: var(--font-mono); line-height: 1; }
.donations-summary-lbl { font-size: 9.5px; color: var(--text3); margin-top: 4px; text-transform: uppercase; letter-spacing: .06em; font-family: var(--font-mono); }

.donations-view-all { display: block; text-align: center; font-size: 11.5px; font-weight: 600; color: var(--accent); text-decoration: none; padding: 10px; margin-top: 6px; border-radius: var(--radius-sm); background: rgba(99,102,241,.06); transition: background var(--transition); }
.donations-view-all:hover { background: rgba(99,102,241,.12); }

.donor-mini-footer { font-size: 10.5px; color: var(--text3); text-align: center; margin-top: 14px; padding-top: 14px; border-top: 1px solid var(--border); }
</style>
</head>
<body>
