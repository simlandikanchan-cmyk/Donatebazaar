...
<span style="display:none;font-size:1px;color:#eef1f8;line-height:1px;max-height:0;max-width:0;opacity:0;overflow:hidden;">
    Your ₹{{ number_format($amount, 0) }} donation to {{ $campaign->title ?? 'this campaign' }} is confirmed — thank you, {{ $donorName }}!
</span>
...
<table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
  ...
  <!-- <tr>
    <td align="center" style="padding-bottom:18px;">
      <span style="font-size:15px;font-weight:700;color:#4f46e5;letter-spacing:.03em;">{{ config('app.name') }}</span>
    </td>
  </tr> -->
      ...
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td bgcolor="#4f46e5" style="background-image:linear-gradient(135deg,#4f46e5,#7c3aed);background-color:#4f46e5;padding:38px 30px 34px;text-align:center;">
            ...
            <p style="color:#ddd6fe;font-size:13px;margin:0;">Official Receipt &middot; {{ $receiptNo }}</p>
          </td>
        </tr>
        ...
        <tr>
          <td style="padding:34px 30px 8px;">
            ...
            {{-- Update the href below to match your real campaign route --}}
            @isset($campaign->slug)
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:30px;">
              <tr>
                <td align="center">
                  <a href="{{ rtrim(config('app.url'), '/') }}/campaigns/{{ $campaign->slug }}"
                ...
                <td style="padding:0 24px;border-top:1px solid #f1f5f9;">
                  <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                      ...
                      <td style="padding:12px 0;font-size:13.5px;color:#4f46e5;font-weight:600;text-align:right;">{{ $row[1] }}</td>
                    </tr>
                  </table>
                </td>
              </tr>
                ...
                <td style="padding:0 24px 20px;border-top:1px solid #f1f5f9;">
                  <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                      ...
                      <td style="padding:14px 0 0;font-size:14.5px;color:#4f46e5;font-weight:700;text-align:right;">₹{{ number_format($netAmount, 2) }}</td>
                    </tr>
                  </table>
                </td>
              </tr>
