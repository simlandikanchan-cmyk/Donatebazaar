...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="s-nav" aria-label="Overview navigation">
        <a href="{{ url('/user/dashboard') }}" class="s-link {{ request()->is('user/dashboard') && !request()->is('user/dashboard/*') ? 'active' : '' }}" @if(request()->is('user/dashboard') && !request()->is('user/dashboard/*')) aria-current="page" @endif>
        ...
        <a href="{{ route('profile.show') }}" class="s-link {{ request()->is('profile') || request()->is('profile/*') ? 'active' : '' }}" @if(request()->is('profile') || request()->is('profile/*')) aria-current="page" @endif>
        ...
        <a href="{{ route('user.level') }}" class="s-link {{ request()->is('user/dashboard/level') ? 'active' : '' }}" @if(request()->is('user/dashboard/level')) aria-current="page" @endif>
    ...
    <nav class="s-nav" aria-label="Campaign navigation">
        ...
        <a href="{{ route('saved.campaigns') }}" class="s-link {{ request()->is('user/dashboard/saved-campaigns') ? 'active' : '' }}" @if(request()->is('user/dashboard/saved-campaigns')) aria-current="page" @endif>
        ...
        @if($sidebarActive > 0)
        <a href="{{ url('/user/dashboard') }}#cGrid" class="s-link" data-action="set-filter" data-filter="active" aria-label="Filter campaigns by active">
        ...
        @endif
        @if($sidebarPending > 0)
        <a href="{{ url('/user/dashboard') }}#cGrid" class="s-link" data-action="set-filter" data-filter="pending" aria-label="Filter campaigns by pending">
        ...
        @endif
        @if($sidebarPaused > 0)
        <a href="{{ url('/user/dashboard') }}#cGrid" class="s-link" data-action="set-filter" data-filter="paused" aria-label="Filter campaigns by paused">
        ...
        <a href="{{ url('/user/dashboard') }}#cGrid" class="s-link" data-action="set-filter" data-filter="rejected" aria-label="Filter campaigns by rejected">
        ...
        @endif
        @if($sidebarExpired > 0)
        <a href="{{ url('/user/dashboard') }}#cGrid" class="s-link" data-action="set-filter" data-filter="expired" aria-label="Filter campaigns by expired">
    ...
    <nav class="s-nav" aria-label="Identity and KYC navigation">
        @php $kycActive = request()->is('user/kyc') || request()->is('kyc/*') ? 'active' : ''; @endphp
        @if(!$sidebarKyc || $sidebarKyc->status === 'rejected')
        <a href="{{ url('/user/kyc') }}" class="s-link {{ $kycActive }}" @if($kycActive) aria-current="page" @endif>
            <svg class="s-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/></svg>
            Submit KYC
    ...
    <nav class="s-nav" aria-label="Finance navigation">
        <a href="{{ route('dashboard.wallet') }}" class="s-link {{ request()->is('user/dashboard/wallet') ? 'active' : '' }}" @if(request()->is('user/dashboard/wallet')) aria-current="page" @endif>
        ...
        <a href="{{ route('recurring.index') }}" class="s-link {{ request()->is('my-recurring-donations') ? 'active' : '' }}" @if(request()->is('my-recurring-donations')) aria-current="page" @endif>
        ...
        <a href="{{ route('gift-cards.index') }}" class="s-link {{ request()->is('gift-cards*') ? 'active' : '' }}" @if(request()->is('gift-cards*')) aria-current="page" @endif>
        ...
        <a href="{{ route('donation.history') }}" class="s-link {{ request()->is('donation-history') || request()->is('donation-history/*') ? 'active' : '' }}" @if(request()->is('donation-history') || request()->is('donation-history/*')) aria-current="page" @endif>
    ...
    <nav class="s-nav" aria-label="Volunteer navigation">
        <a href="{{ route('volunteer.dashboard') }}" class="s-link {{ request()->is('my-volunteer-dashboard') ? 'active' : '' }}" @if(request()->is('my-volunteer-dashboard')) aria-current="page" @endif>
            <svg class="s-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"/></svg>
            My Dashboard
        </a>
        <a href="{{ route('volunteer.apply') }}" class="s-link {{ request()->is('volunteer/apply') ? 'active' : '' }}" @if(request()->is('volunteer/apply')) aria-current="page" @endif>
            <svg class="s-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4"/></svg>
            Apply as Volunteer
        </a>
    </nav>
    ...
    <nav class="s-nav" aria-label="Blogs navigation">
        <a href="{{ url('/user/dashboard/blogs') }}" class="s-link {{ request()->is('user/dashboard/blogs') || request()->is('user/dashboard/blogs/*') && !request()->is('user/dashboard/blogs/create') ? 'active' : '' }}" @if(request()->is('user/dashboard/blogs') || (request()->is('user/dashboard/blogs/*') && !request()->is('user/dashboard/blogs/create'))) aria-current="page" @endif>
        ...
        <a href="{{ url('/user/dashboard/blogs/create') }}" class="s-link {{ request()->is('user/dashboard/blogs/create') ? 'active' : '' }}" @if(request()->is('user/dashboard/blogs/create')) aria-current="page" @endif>
