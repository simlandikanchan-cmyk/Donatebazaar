...
<aside class="sidebar" id="sidebar">
  ...
  <div class="s-admin-pill">
    ...
    <div style="flex:1;overflow:hidden;">
      <div class="s-admin-name"><?php echo e(auth()->user()->name ?? 'Admin'); ?></div>
  ...
  <nav class="s-nav">
    <a href="<?php echo e(route('admin.dashboard')); ?>" class="s-link active">
  ...
  <nav class="s-nav">
    <a href="#cGrid" class="s-link" onclick="setFilter('all');return false;">
      ...
      All Campaigns
      <span class="s-chip sc-purple"><?php echo e($totalCampaigns); ?></span>
    </a>
  </nav>

  <div class="s-section">Manage</div>
  <nav class="s-nav">
    <a href="<?php echo e(url('/admin/categories')); ?>" class="s-link">
    ...
    <a href="<?php echo e(url('/admin/category-products')); ?>" class="s-link">
    ...
    <a href="<?php echo e(url('/admin/partnerships')); ?>" class="s-link">
    ...
    <a href="<?php echo e(url('/admin/messages')); ?>" class="s-link">
    ...
    <a href="<?php echo e(url('/admin/blogs')); ?>" class="s-link">
    ...
    <a href="<?php echo e(url('/admin/applications')); ?>" class="s-link">
  ...
  <nav class="s-nav">
    <a href="<?php echo e(route('admin.job_posts.index')); ?>" class="s-link">
      <svg class="s-ico" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
      All Job Posts
      <span class="s-chip sc-teal"><?php echo e(\App\Models\JobPost::count()); ?></span>
    </a>
    <a href="<?php echo e(route('admin.job_posts.create')); ?>" class="s-link">
    ...
    <a href="<?php echo e(route('admin.job_post_applications.index')); ?>" class="s-link">
      <svg class="s-ico" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0"/></svg>
      Job Applicants
      <span class="s-chip sc-amber"><?php echo e(\App\Models\JobPostApplication::count()); ?></span>
    </a>
  </nav>
  ...
  <div class="s-bottom">
    <a href="<?php echo e(route('profile.show')); ?>" class="s-link" style="color:var(--a);margin-bottom:2px;">
    ...
    <a href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault();document.getElementById('lf').submit();" class="s-link" style="color:var(--red);">
...
<div class="main">
  <header class="topbar">
    ...
    <div class="tb-right">
      ...
      <button class="tb-btn" title="Notifications">
        ...
        <?php if($cntPending > 0): ?><span class="notif-dot"></span><?php endif; ?>
      </button>
      ...
      <div class="av-wrap" id="avWrap">
        ...
        <div class="av-dd" id="avDD">
          <div class="dd-hdr">
            <div class="dd-name"><?php echo e(auth()->user()->name ?? 'Admin'); ?></div>
            <div class="dd-email"><?php echo e(auth()->user()->email ?? ''); ?></div>
          </div>
          <a href="<?php echo e(route('profile.show')); ?>" class="dd-item accent">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
            View Profile
          </a>
          <a href="<?php echo e(route('profile.edit')); ?>" class="dd-item">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
            Edit Profile
          </a>
          <div class="dd-sep"></div>
          <a href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault();document.getElementById('lf').submit();" class="dd-item danger">
  ...
  <div class="body">
    ...
    <div class="hero">
      <div class="hero-left">
        <div class="hero-tag"><span class="hero-tag-dot"></span><?php echo e($greeting); ?>, Administrator</div>
        <div class="hero-name"><?php echo e(auth()->user()->name ?? 'Admin'); ?> 👋</div>
        ...
        <div class="hero-badges">
          <?php if($cntPending > 0): ?>
            <span class="hero-badge hb-amber">⏱ <?php echo e($cntPending); ?> awaiting review</span>
          <?php else: ?>
            <span class="hero-badge hb-green">✓ All caught up</span>
          <?php endif; ?>
          <span class="hero-badge hb-green"><?php echo e($cntActive); ?> active campaigns</span>
          <span class="hero-badge hb-purple"><?php echo e($approvalRate); ?>% approval rate</span>
          <span class="hero-badge hb-teal"><?php echo e($activeJobs); ?> open jobs</span>
        </div>
      </div>
      <div class="hero-right">
        ...
        <?php endif; ?>
        <a href="<?php echo e(route('admin.job_posts.create')); ?>" class="hero-btn hero-btn-teal">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4"/></svg>
          Post a Job
        </a>
        <a href="<?php echo e(route('profile.show')); ?>" class="hero-btn hero-btn-ghost">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
          My Profile
        </a>
      </div>
    ...
    <div class="stats-grid">
      <div class="stat">
        ...
        <div class="stat-body"><div class="stat-lbl">Total Campaigns</div><div class="stat-val sv-a"><?php echo e($totalCampaigns); ?></div><div class="stat-foot">All time on platform</div></div>
      </div>
      <div class="stat">
        ...
        <div class="stat-body"><div class="stat-lbl">Pending Review</div><div class="stat-val sv-amber"><?php echo e($cntPending); ?></div><div class="stat-foot">Awaiting your decision</div></div>
      </div>
      <div class="stat">
        ...
        <div class="stat-body"><div class="stat-lbl">Active Now</div><div class="stat-val sv-green"><?php echo e($cntActive); ?></div><div class="stat-foot">Currently running live</div></div>
      </div>
      <div class="stat">
        ...
        <div class="stat-body"><div class="stat-lbl">Approval Rate</div><div class="stat-val sv-blue"><?php echo e($approvalRate); ?>%</div><div class="stat-foot">Of all campaigns</div></div>
      </div>
      <div class="stat">
        ...
        <div class="stat-body"><div class="stat-lbl">Active Jobs</div><div class="stat-val sv-teal"><?php echo e($activeJobs); ?></div><div class="stat-foot"><a href="<?php echo e(route('admin.job_posts.create')); ?>">+ Post new job →</a></div></div>
      </div>
    </div>
    ...
    <div class="analytics-row">
      ...
      <div class="status-panel">
        ...
        <div class="sp-row" onclick="setFilter('active')"><div class="sp-left"><div class="sp-dot" style="background:var(--green)"></div><span class="sp-label">Active</span></div><span class="sp-val"><?php echo e($cntActive); ?></span></div>
        <div class="sp-row" onclick="setFilter('pending')"><div class="sp-left"><div class="sp-dot" style="background:var(--amber)"></div><span class="sp-label">Pending</span></div><span class="sp-val"><?php echo e($cntPending); ?></span></div>
        <div class="sp-row" onclick="setFilter('paused')"><div class="sp-left"><div class="sp-dot" style="background:var(--a)"></div><span class="sp-label">Paused</span></div><span class="sp-val"><?php echo e($cntPaused); ?></span></div>
        <div class="sp-row" onclick="setFilter('rejected')"><div class="sp-left"><div class="sp-dot" style="background:var(--red)"></div><span class="sp-label">Rejected</span></div><span class="sp-val"><?php echo e($cntRejected); ?></span></div>
        <div class="sp-row" onclick="setFilter('inactive')"><div class="sp-left"><div class="sp-dot" style="background:var(--gray)"></div><span class="sp-label">Inactive / Expired</span></div><span class="sp-val"><?php echo e($cntExpired + $cntCompleted); ?></span></div>
        <div class="sp-prog">
          <div class="sp-prog-lbl"><span>Approval rate</span><span><?php echo e($approvalRate); ?>%</span></div>
    ...
    <div class="qnav">
      ...
      <a href="<?php echo e($item['url']); ?>" class="qnav-card" style="animation-delay:<?php echo e($item['delay']); ?>;--qc:<?php echo e($item['bg']); ?>;">
        <div class="qnav-ico" style="background:<?php echo e($item['bg']); ?>;color:<?php echo e($item['color']); ?>;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><?php echo $item['icon']; ?></svg></div>
        <div><div class="qnav-lbl"><?php echo e($item['lbl']); ?></div><div class="qnav-sub"><?php echo e($item['sub']); ?></div></div>
      </a>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>

    <?php $cntAll = $cntPending + $cntActive + $cntPaused + $cntRejected + $cntExpired + $cntCompleted; ?>
    <div class="sec-hdr" id="cGrid">
      <div class="sec-ttl">All Campaigns</div>
      <div class="sec-right">
        <div class="ftabs" id="ftabs">
          <button class="ftab on" data-filter="all">All <span class="cnt"><?php echo e($cntAll); ?></span></button>
          <button class="ftab" data-filter="pending">Pending <span class="cnt"><?php echo e($cntPending); ?></span></button>
          <button class="ftab" data-filter="active">Active <span class="cnt"><?php echo e($cntActive); ?></span></button>
          <button class="ftab" data-filter="paused">Paused <span class="cnt"><?php echo e($cntPaused); ?></span></button>
          <button class="ftab" data-filter="inactive">Inactive <span class="cnt"><?php echo e($cntExpired + $cntCompleted); ?></span></button>
          <button class="ftab" data-filter="rejected">Rejected <span class="cnt"><?php echo e($cntRejected); ?></span></button>
        </div>
      </div>
    </div>
    ...
    <div class="c-grid" id="campaignGrid">
      ...
      <?php $__currentLoopData = $pendingCampaigns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <?php
      ...
      ?>
      <div class="c-card" data-filter="pending" data-title="<?php echo e(strtolower($c->title)); ?>" data-amount="<?php echo e($c->goal_amount); ?>" data-date="<?php echo e($c->created_at); ?>" style="animation-delay:<?php echo e($i*0.04); ?>s">
        <div class="c-thumb">
          <?php if($c->cover_image): ?><img src="<?php echo e(asset('storage/'.$c->cover_image)); ?>" alt="<?php echo e($c->title); ?>" loading="lazy"><div class="c-overlay"></div>
          <?php else: ?><div class="c-placeholder"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg></div><?php endif; ?>
          <div class="c-badge-pos"><span class="badge b-pending">Pending</span></div>
        </div>
        <div class="c-user">
          <div class="c-uav"><?php echo e($uInit); ?></div>
          <div><div class="c-uname"><?php echo e($uName); ?></div><?php if($uEmail): ?><div class="c-uemail"><?php echo e($uEmail); ?></div><?php endif; ?></div>
        </div>
        <div class="c-body">
          <div class="c-title"><?php echo e($c->title); ?></div>
          <div class="prog">
            <div class="prog-nums"><span class="prog-raised">₹<?php echo e(number_format($raised)); ?></span><span class="prog-goal">of ₹<?php echo e(number_format($c->goal_amount)); ?></span></div>
            <div class="prog-bar"><div class="prog-fill" style="width:<?php echo e($pct); ?>%"></div></div>
            <div class="prog-pct"><?php echo e($pct); ?>% funded</div>
          </div>
          <div class="c-actions">
            <form action="<?php echo e(route('admin.campaign.approve',$c->id)); ?>" method="POST" style="flex:1;" onsubmit="return handleSub(this,'Approving…')">
              <?php echo csrf_field(); ?><button class="c-btn c-btn-approve" style="width:100%;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7"/></svg>Approve</button>
            </form>
            <button type="button" onclick="openReject(<?php echo e($c->id); ?>)" class="c-btn c-btn-reject"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12"/></svg>Reject</button>
            <a href="<?php echo e(route('admin.campaign.show',$c->id)); ?>" class="c-btn c-btn-view"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg></a>
          </div>
        </div>
      </div>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      ...
      <?php $__currentLoopData = $activeCampaigns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <?php
        $raised=$c->raised_amount??0;$goal=$c->goal_amount>0?$c->goal_amount:1;$pct=min(100,round(($raised/$goal)*100));
        $isPaused=($c->campaign_state==='paused');$fv=$isPaused?'paused':'active';
        $uName=$c->user?->name??'Unknown';$uEmail=$c->user?->email??'';$uInit=strtoupper(substr($uName,0,1));
      ?>
      <div class="c-card" data-filter="<?php echo e($fv); ?>" data-title="<?php echo e(strtolower($c->title)); ?>" data-amount="<?php echo e($c->goal_amount); ?>" data-date="<?php echo e($c->created_at); ?>" style="animation-delay:<?php echo e($i*0.04); ?>s">
        <div class="c-thumb">
          <?php if($c->cover_image): ?><img src="<?php echo e(asset('storage/'.$c->cover_image)); ?>" alt="<?php echo e($c->title); ?>" loading="lazy"><div class="c-overlay"></div>
          <?php else: ?><div class="c-placeholder"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg></div><?php endif; ?>
          <div class="c-badge-pos"><span class="badge <?php echo e($isPaused?'b-paused':'b-active'); ?>"><?php echo e($isPaused?'Paused':'Active'); ?></span></div>
        </div>
        <div class="c-user">
          <div class="c-uav"><?php echo e($uInit); ?></div>
          <div><div class="c-uname"><?php echo e($uName); ?></div><?php if($uEmail): ?><div class="c-uemail"><?php echo e($uEmail); ?></div><?php endif; ?></div>
        ...
        <div class="c-body">
          <div class="c-title"><?php echo e($c->title); ?></div>
          <?php if($isPaused && $c->pause_reason): ?><div class="reason reason-amber"><div class="reason-lbl">⏸ PAUSE REASON</div><div class="reason-txt"><?php echo e($c->pause_reason); ?></div></div><?php endif; ?>
          <div class="prog">
            <div class="prog-nums"><span class="prog-raised">₹<?php echo e(number_format($raised)); ?></span><span class="prog-goal">of ₹<?php echo e(number_format($c->goal_amount)); ?></span></div>
            <div class="prog-bar"><div class="prog-fill" style="width:<?php echo e($pct); ?>%"></div></div>
            <div class="prog-pct"><?php echo e($pct); ?>% funded</div>
          ...
          <div class="c-actions">
            <?php if(!$isPaused): ?>
            <button type="button" onclick="openPause(<?php echo e($c->id); ?>)" class="c-btn c-btn-pause" style="flex:1;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M10 9v6m4-6v6m7-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>Pause</button>
            <?php else: ?>
            <form action="<?php echo e(route('admin.campaign.resume',$c->id)); ?>" method="POST" style="flex:1;" onsubmit="return handleSub(this,'Resuming…')">
              <?php echo csrf_field(); ?><button class="c-btn c-btn-resume" style="width:100%;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z"/><path stroke-linecap="round" stroke-linejoin="round" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>Resume</button>
            </form>
            <?php endif; ?>
            <a href="<?php echo e(route('admin.campaign.show',$c->id)); ?>" class="c-btn c-btn-view" style="flex:1;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>View</a>
          </div>
        </div>
      </div>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      ...
      <?php $__currentLoopData = $rejectedCampaigns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <?php
        $raised=$c->raised_amount??0;$goal=$c->goal_amount>0?$c->goal_amount:1;$pct=min(100,round(($raised/$goal)*100));
        $uName=$c->user?->name??'Unknown';$uEmail=$c->user?->email??'';$uInit=strtoupper(substr($uName,0,1));
      ?>
      <div class="c-card" data-filter="rejected" data-title="<?php echo e(strtolower($c->title)); ?>" data-amount="<?php echo e($c->goal_amount); ?>" data-date="<?php echo e($c->created_at); ?>" style="animation-delay:<?php echo e($i*0.04); ?>s">
        <div class="c-thumb">
          <?php if($c->cover_image): ?><img src="<?php echo e(asset('storage/'.$c->cover_image)); ?>" alt="<?php echo e($c->title); ?>" loading="lazy"><div class="c-overlay"></div>
          <?php else: ?><div class="c-placeholder"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg></div><?php endif; ?>
        ...
        <div class="c-user">
          <div class="c-uav" style="background:linear-gradient(135deg,#f04444,#dc2626);"><?php echo e($uInit); ?></div>
          <div><div class="c-uname"><?php echo e($uName); ?></div><?php if($uEmail): ?><div class="c-uemail"><?php echo e($uEmail); ?></div><?php endif; ?></div>
        </div>
        <div class="c-body">
          <div class="c-title"><?php echo e($c->title); ?></div>
          <?php if($c->rejection_reason): ?><div class="reason reason-red"><div class="reason-lbl">✕ REJECTION REASON</div><div class="reason-txt"><?php echo e($c->rejection_reason); ?></div></div><?php endif; ?>
          <div class="prog">
            <div class="prog-nums"><span class="prog-raised">₹<?php echo e(number_format($raised)); ?></span><span class="prog-goal">of ₹<?php echo e(number_format($c->goal_amount)); ?></span></div>
            <div class="prog-bar"><div class="prog-fill prog-fill-red" style="width:<?php echo e($pct); ?>%"></div></div>
            <div class="prog-pct" style="color:var(--red)"><?php echo e($pct); ?>% funded</div>
          </div>
          <div class="c-actions">
      ...
      <?php $__currentLoopData = $inactiveCampaigns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <?php
        $raised=$c->raised_amount??0;$goal=$c->goal_amount>0?$c->goal_amount:1;$pct=min(100,round(($raised/$goal)*100));
        $uName=$c->user?->name??'Unknown';$uEmail=$c->user?->email??'';$uInit=strtoupper(substr($uName,0,1));
      ?>
      <div class="c-card" data-filter="inactive" data-title="<?php echo e(strtolower($c->title)); ?>" data-amount="<?php echo e($c->goal_amount); ?>" data-date="<?php echo e($c->created_at); ?>" style="animation-delay:<?php echo e($i*0.04); ?>s">
        <div class="c-thumb">
          <?php if($c->cover_image): ?><img src="<?php echo e(asset('storage/'.$c->cover_image)); ?>" alt="<?php echo e($c->title); ?>" loading="lazy"><div class="c-overlay"></div>
          <?php else: ?><div class="c-placeholder"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg></div><?php endif; ?>
          <div class="c-badge-pos"><span class="badge b-inactive"><?php echo e($c->status==='completed'?'Completed':'Inactive'); ?></span></div>
        </div>
        <div class="c-user">
          <div class="c-uav" style="background:linear-gradient(135deg,#64748b,#475569);"><?php echo e($uInit); ?></div>
          <div><div class="c-uname"><?php echo e($uName); ?></div><?php if($uEmail): ?><div class="c-uemail"><?php echo e($uEmail); ?></div><?php endif; ?></div>
        </div>
        <div class="c-body">
          <div class="c-title"><?php echo e($c->title); ?></div>
          <div class="prog">
            <div class="prog-nums"><span class="prog-raised">₹<?php echo e(number_format($raised)); ?></span><span class="prog-goal">of ₹<?php echo e(number_format($c->goal_amount)); ?></span></div>
            <div class="prog-bar"><div class="prog-fill prog-fill-gray" style="width:<?php echo e($pct); ?>%"></div></div>
            <div class="prog-pct" style="color:#64748b"><?php echo e($pct); ?>% funded</div>
          </div>
          <div class="c-actions">
            <a href="<?php echo e(route('admin.campaign.show',$c->id)); ?>" class="c-btn c-btn-view" style="flex:1;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>View Details</a>
          </div>
    ...
    <div class="pagination-wrap"><?php echo e($activeCampaigns->links()); ?></div>
  </div>
</div>
</div>
...
setTimeout(function(){
  ...
  if(b)b.style.width='<?php echo e($approvalRate??0); ?>%';
},700);
...
<?php if(session('success')): ?> setTimeout(function(){toast(<?php echo json_encode(session('success'), 15, 512) ?>,'success');},200); <?php endif; ?>
<?php if(session('error')): ?>   setTimeout(function(){toast(<?php echo json_encode(session('error'), 15, 512) ?>,'error');},200);   <?php endif; ?>
<?php if(session('warning')): ?> setTimeout(function(){toast(<?php echo json_encode(session('warning'), 15, 512) ?>,'warn');},200);  <?php endif; ?>
...
var lineChart;
var chartLabels=<?php echo json_encode($chartLabels, 15, 512) ?>;
var chartTotal=<?php echo json_encode($chartTotal, 15, 512) ?>;
var chartApproved=<?php echo json_encode($chartActive, 15, 512) ?>;
...
</html><?php /**PATH C:\xampp\htdocs\fundraise\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>