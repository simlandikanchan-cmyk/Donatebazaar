<div class="hero-wrap">
    ...
    <div class="hero-slide active">
        <img src="<?php echo e(asset('images/2149012198.jpg')); ?>" alt="Be Someone's Hope Today">
        <div class="hero-overlay">
            <div class="hero-content">
                ...
                <div class="hero-btns">
                    <a href="<?php echo e(route('all.campaigns')); ?>" class="btn btn-white">
                        Donate Now
    ...
    <div class="hero-slide">
        <img src="<?php echo e(asset('images/2149012178.jpg')); ?>" alt="Save Children's Lives">
        <div class="hero-overlay">
            <div class="hero-content">
                ...
                <div class="hero-btns">
                    <a href="<?php echo e(route('all.campaigns')); ?>" class="btn btn-white">Donate Now <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M5 12h14M12 5l7 7-7 7"/></svg></a>
    ...
    <div class="hero-slide">
        <img src="<?php echo e(asset('images/18576.jpg')); ?>" alt="Be the Change">
        <div class="hero-overlay">
            <div class="hero-content">
...
<?php /**PATH C:\xampp\htdocs\fundraise\resources\views/home/sections/hero.blade.php ENDPATH**/ ?>