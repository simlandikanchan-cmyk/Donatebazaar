...
<div class="hero">
    <div class="hero-bg">
        <img src="<?php echo e($campaign->cover_image ? asset('storage/'.$campaign->cover_image) : asset('images/about.jpg')); ?>"
             alt="<?php echo e($campaign->title); ?>" loading="eager">
    </div>
    ...
    <div class="hero-float-cards">
        <div class="hero-float-card">
            ...
            <div class="fcard-val">₹<?php echo e(number_format($raised)); ?></div>
            <div class="fcard-sub">of ₹<?php echo e(number_format($goal)); ?> goal</div>
        </div>
        <div class="hero-float-card">
            <div class="fcard-lbl">Donors</div>
            <div class="fcard-val"><?php echo e(number_format($donors)); ?></div>
            <div class="fcard-sub">people contributed</div>
        </div>
        <?php if($daysLeft !== null): ?>
        <div class="hero-float-card">
            <div class="fcard-lbl"><?php echo e($daysLeft > 0 ? 'Days Left' : 'Campaign'); ?></div>
            <div class="fcard-val"><?php echo e($daysLeft > 0 ? $daysLeft : '🎯'); ?></div>
            <div class="fcard-sub"><?php echo e($daysLeft > 0 ? 'until campaign ends' : 'Ends today!'); ?></div>
        </div>
        <?php endif; ?>
    </div>
    ...
    <div class="hero-inner">
        <div class="hero-content">
            <div class="hero-breadcrumb">
                ...
                <a href="<?php echo e(route('all.campaigns')); ?>">Campaigns</a>
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="9 18 15 12 9 6"/></svg>
                <span style="color:rgba(255,255,255,.75)"><?php echo e(Str::limit($campaign->title, 40)); ?></span>
            </div>

            <div class="hero-cat-pill"><?php echo e($campaign->category->name ?? 'General'); ?></div>
            <h1 class="hero-title"><?php echo e($campaign->title); ?></h1>
            ...
            <div class="hero-meta">
                <span class="hero-pill">
                    ...
                    <?php echo e($campaign->created_at->format('d M Y')); ?>

                </span>
                <span class="hero-pill">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
                    By <?php echo e($campaign->user->name ?? 'DonateBazaar'); ?>

                </span>
                <span class="hero-pill">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/></svg>
                    <?php echo e(number_format($donors)); ?> Donors
                </span>
                <?php if($daysLeft !== null): ?>
                <span class="hero-pill" style="background:rgba(16,185,129,.15);border-color:rgba(16,185,129,.25)">
                    ...
                    <span style="color:#34d399"><?php echo e($daysLeft > 0 ? $daysLeft . ' days left' : 'Ends today'); ?></span>
                </span>
                <?php endif; ?>
            ...
            <div class="hero-progress-wrap">
                <div class="hero-progress-track">
                    <div class="hero-progress-fill" style="width:<?php echo e($percent); ?>%"></div>
                </div>
                <div class="hero-progress-meta">
                    <div>
                        <div class="hero-raised">₹<?php echo e(number_format($raised)); ?></div>
                        <div class="hero-goal">of ₹<?php echo e(number_format($goal)); ?> goal</div>
                    </div>
                    <?php if($goalReached): ?>
                    <div class="goal-reached-pill">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="20 6 9 17 4 12"/></svg>
                        Goal Reached · <?php echo e($percentRaw); ?>%
                    </div>
                    <?php else: ?>
                    <div class="hero-pct"><?php echo e($percentRaw); ?>% funded</div>
                    <?php endif; ?>
                </div>
                <?php if($goalReached): ?>
    ...
    <div class="left-col">
        ...
        <div class="sec-card reveal">
            <div class="sec-body-pad">
                ...
                <h2 class="sec-title"><?php echo e($campaign->title); ?></h2>
                <div class="sec-text"><?php echo nl2br(e($campaign->description)); ?></div>
                ...
                <div class="mission-chips">
                    ...
                    <span class="mission-chip chip-location">
                        <span class="chip-icon"><svg viewBox="0 0 24 24" fill="none" stroke="#475569" stroke-width="2.5"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></svg></span><?php echo e($campaign->location); ?>
            ...
            <div class="stats-strip">
                <div class="stat-cell">
                    <span class="stat-val">₹<?php echo e(number_format($raised)); ?></span>
                    <div class="stat-lbl">Total Raised</div>
                </div>
                <div class="stat-cell stat-money">
                    <span class="stat-val">₹<?php echo e(number_format($moneyRaised)); ?></span>
                    <div class="stat-lbl">Cash Donations</div>
                </div>
                <div class="stat-cell stat-product">
                    <span class="stat-val">₹<?php echo e(number_format($productRaised)); ?></span>
            ...
            <div class="sec-body-pad">
                ...
                <?php if($videoEmbed): ?>
                    <div class="video-wrap">
                        <iframe src="<?php echo e($videoEmbed); ?>" title="Campaign video" allowfullscreen
                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture">
                        </iframe>
                    </div>
                <?php else: ?>
                    <a href="<?php echo e($videoUrl); ?>" target="_blank" rel="noopener" class="video-link-fallback">
            ...
            <div class="sec-body-pad">
                ...
                <div class="products-grid" style="margin-top:20px">
                    ...
                    <div class="product-card-left">
                        ...
                        <div class="product-card-left-name"><?php echo e($product->name); ?></div>
                        <?php if($product->description): ?>
                        <div class="product-card-left-desc"><?php echo e($product->description); ?></div>
                        <?php endif; ?>
                        <div class="product-card-left-footer">
                            <span class="product-price">₹<?php echo e(number_format($product->price)); ?></span>
                            <?php if(isset($product->stock)): ?>
                                <?php if($product->stock > 0): ?>
                                    <span class="product-qty-badge"><span class="product-status-dot"></span><?php echo e($product->stock); ?> left</span>
                                <?php else: ?>
        ...
        <div class="sec-card reveal d2">
            <div class="sec-body-pad">
                ...
                <div class="updates-timeline" style="margin-top:26px">
                    <?php $__currentLoopData = $updates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $update): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="update-item">
                        ...
                        <div class="update-body">
                            <div class="update-meta">
                                <span class="update-num-badge">Update #<?php echo e($i + 1); ?></span>
                                <?php if($update->created_at): ?>
                                <span class="update-date"><?php echo e($update->created_at->format('d M Y')); ?> · <?php echo e($update->created_at->diffForHumans()); ?></span>
                                <?php endif; ?>
                            </div>
                            <div class="update-title"><?php echo e($update->title); ?></div>
                            <?php if($update->body): ?>
                            <div class="update-text"><?php echo nl2br(e($update->body)); ?></div>
                            <?php endif; ?>
                            <?php if($update->document): ?>
                            <a href="<?php echo e(asset('storage/' . $update->document)); ?>" target="_blank" rel="noopener" class="update-doc-link">
            ...
            <div class="sec-body-pad">
                ...
                <div class="impact-grid">
                    <div class="impact-card">
                        <img src="<?php echo e(asset('images/donation1 (3).jpg')); ?>" class="impact-img" alt="Relief Kits" loading="lazy">
                    ...
                    <div class="impact-card">
                        <img src="<?php echo e(asset('images/donation1 (2).jpg')); ?>" class="impact-img" alt="Medical Care" loading="lazy">
                        <div class="impact-body">
                    ...
                    <div class="impact-card">
                        <img src="<?php echo e(asset('images/donation1 (1).jpg')); ?>" class="impact-img" alt="Shelter" loading="lazy">
                        <div class="impact-body">
        ...
        <div class="sec-card reveal d2">
            <div class="sec-body-pad">
                ...
                <div class="why-grid" style="margin-top:4px">
                    <?php $__currentLoopData = $whys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $w): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="why-item" style="--wi-color:<?php echo e($w['wi']); ?>">
                        <div class="why-icon" style="background:<?php echo e($w['bg']); ?>">
                            <svg viewBox="0 0 24 24" fill="none" stroke="<?php echo e($w['color']); ?>" stroke-width="1.8"><?php echo $w['svg']; ?></svg>
                        </div>
                        <div>
                            <div class="why-name"><?php echo e($w['title']); ?></div>
                            <div class="why-desc"><?php echo e($w['desc']); ?></div>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            ...
            <div class="sec-body-pad">
                ...
                <div class="faq-list" style="margin-top:4px">
                    ...
                    <div class="faq-item" id="faq-<?php echo e($i); ?>">
                        <div class="faq-q" onclick="toggleFaq(<?php echo e($i); ?>)">
                            <span class="faq-q-text"><?php echo e($faq[0]); ?></span>
                            <div class="faq-chevron">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="6 9 12 15 18 9"/></svg>
                            </div>
                        </div>
                        <div class="faq-answer" id="faq-ans-<?php echo e($i); ?>">
                            <div class="faq-answer-inner"><?php echo e($faq[1]); ?></div>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
        ...
        <?php if($campaign->donations && $campaign->donations->count() > 0): ?>
        <div class="sec-card reveal d3">
            <div class="sec-body-pad">
                ...
                <div style="display:flex;flex-direction:column;gap:10px;">
                    <?php $__currentLoopData = $campaign->donations->where('payment_status','completed')->sortByDesc('created_at')->take(10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $donation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="donor-row">
                        <div class="donor-row-left">
<div class="donor-avatar-new"
     style="<?php echo e($donation->donation_type === 'product' 
    ...
    <?php if($avatar): ?>
        <img src="<?php echo e(Storage::url($avatar)); ?>"
             alt="<?php echo e($donation->donor_name); ?>"
             style="width:100%;height:100%;object-fit:cover;border-radius:inherit;">
    <?php else: ?>
        <?php echo e(strtoupper(substr($donation->donor_name ?? 'A', 0, 1))); ?>

    <?php endif; ?>
</div>
                            <div>
                                <div class="donor-info-name"><?php echo e($donation->is_anonymous ? 'Anonymous Donor' : ($donation->donor_name ?? 'Anonymous')); ?></div>
                                <div class="donor-info-time"><?php echo e($donation->created_at->diffForHumans()); ?></div>
                                <span class="donor-type-badge <?php echo e($donation->donation_type === 'product' ? 'donor-type-product' : 'donor-type-money'); ?>">
                                    <?php echo e($donation->donation_type === 'product' ? 'Product' : 'Cash'); ?>

                                </span>
                            </div>
                        </div>
                        <div>
                            <div class="donor-amount">₹<?php echo e(number_format($donation->total_amount, 2)); ?></div>
        ...
        <div class="donate-card-new reveal-right" id="donateCardEl">
            ...
            <div class="donate-head-new">
                ...
                <div class="donate-raised-row-new">
                    <span class="donate-raised-new">₹<?php echo e(number_format($raised)); ?></span>
                    <span class="donate-goal-new">of ₹<?php echo e(number_format($goal)); ?></span>
                </div>
                <div class="donate-prog-track-new">
                    <div class="donate-prog-fill-new" style="width:<?php echo e($percent); ?>%"></div>
                </div>
                <div class="donate-prog-meta-new">
                    <?php if($goalReached): ?>
                    <span class="donate-pct-new" style="color:var(--accent2)"> Goal Reached · <?php echo e($percentRaw); ?>%</span>
                    <?php else: ?>
                    <span class="donate-pct-new"><?php echo e($percentRaw); ?>% funded</span>
                    <?php endif; ?>
                    <span class="donate-donors-count-new">· <?php echo e($donors); ?> donors</span>
                </div>
<?php if($goalReached): ?>
...
<?php endif; ?>
                ...
                <?php if($moneyRaised > 0 || $productRaised > 0): ?>
                <div class="donate-breakdown">
                    <?php if($moneyRaised > 0): ?>
                    <span class="donate-breakdown-pill dbp-money">
                         Cash ₹<?php echo e(number_format($moneyRaised)); ?>

                    </span>
                    <?php endif; ?>
                    <?php if($productRaised > 0): ?>
                    <span class="donate-breakdown-pill dbp-product">
                         Products ₹<?php echo e(number_format($productRaised)); ?>
            ...
            <div class="main-donate-tabs">
                <button type="button" id="tabProducts"
                        class="main-donate-tab <?php echo e($products->count() > 0 ? 'active-products' : ''); ?>"
                        onclick="switchMainTab('products')">Donate Products</button>
                <button type="button" id="tabMoney"
                        class="main-donate-tab <?php echo e($products->count() === 0 ? 'active-money' : ''); ?>"
                        onclick="switchMainTab('money')">Donate Money</button>
            </div>

            
            <div id="panelProducts" style="<?php echo e($products->count() === 0 ? 'display:none' : ''); ?>">
                <div class="panel-products">
                    ...
                    <div class="dp-grid" id="dpGrid">
                        ...
                        ?>
                        <div class="dp-card"
                             id="dpCard_<?php echo e($product->id); ?>"
                             data-id="<?php echo e($product->id); ?>"
                             data-price="<?php echo e($product->price); ?>"
                             data-name="<?php echo e($product->name); ?>"
                             style="<?php echo e($idx >= 6 ? 'display:none' : ''); ?>"
                             data-hidden="<?php echo e($idx >= 6 ? '1' : '0'); ?>">
...
<?php endif; ?>
                            ...
                            <div id="dpAddWrap_<?php echo e($product->id); ?>">
                                <button type="button" class="dp-add-btn" id="dpAddBtn_<?php echo e($product->id); ?>"
                                        onclick="addProductToCart(<?php echo e($product->id); ?>)">
                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>
                                    Add
                                </button>
                            </div>
                            <div class="dp-counter" id="dpCounter_<?php echo e($product->id); ?>">
                                <button type="button" class="dp-minus" onclick="changeQty(<?php echo e($product->id); ?>, -1)">−</button>
                                <span class="dp-count" id="dpCount_<?php echo e($product->id); ?>">1</span>
                                <button type="button" class="dp-plus"  onclick="changeQty(<?php echo e($product->id); ?>, +1)">+</button>
                            </div>

                            <div class="dp-info">
                                <div class="dp-name" onclick="toggleDpExpand(<?php echo e($product->id); ?>)">
                                    <span class="dp-name-text"><?php echo e($product->name); ?></span>
                                    <?php if($product->description): ?>
                                ...
                                <?php if($product->description): ?>
                                <div class="dp-expanded-desc"><?php echo e($product->description); ?></div>
                                <?php endif; ?>
                                <?php if($qtyNeeded > 0): ?>
                                <div class="dp-qty-row">
                                    <div class="dp-qty-label"><?php echo e(number_format($qtyNeeded)); ?> remaining</div>
                                    <div class="dp-qty-track"><div class="dp-qty-fill" style="width:<?php echo e($soldPct); ?>%"></div></div>
                                </div>
                                <?php endif; ?>
                                <div class="dp-price">₹<?php echo e(number_format($product->price)); ?>/unit</div>
                            </div>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                    ...
                    <button type="button" class="dp-load-more" id="dpLoadMore" onclick="loadMoreProducts()">
                        ...
                        Show <?php echo e($products->count() - 6); ?> more products
                    </button>
                    <?php endif; ?>

                    <form id="productDonateForm" action="<?php echo e(route('donate.redirect', $campaign->id)); ?>" method="POST" style="display:none">
                        <?php echo csrf_field(); ?>
            ...
            <div id="panelMoney" style="<?php echo e($products->count() > 0 ? 'display:none' : ''); ?>">
                <div class="panel-money">
                    ...
                    <div class="existing-sub-new">
                        ...
                        <div>You have an active <strong><?php echo e($activeSub->frequency); ?></strong> donation of <strong>₹<?php echo e(number_format($activeSub->amount)); ?></strong>. Next billing: <?php echo e($activeSub->next_billing_date?->format('d M Y') ?? 'Soon'); ?>.</div>
                    </div>
                    <?php endif; ?>
                    <?php endif; ?>

                    <div class="amt-grid-new">
                        <?php $__currentLoopData = [100,500,1000,2000,5000,10000,20000,50000,100000]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $amt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <button type="button" class="amt-btn-new" onclick="pickAmtNew(<?php echo e($amt); ?>,this)">
                            ₹<?php echo e($amt >= 1000 ? number_format($amt/1000).'K' : $amt); ?>
                    ...
                    <div id="mFormOnce">
                        ...
                        <?php endif; ?>
                        <form action="<?php echo e(route('donate.redirect', $campaign->id)); ?>" method="POST"
                    ...
                    <div id="mFormWeekly" style="display:none">
                        <?php if(auth()->guard()->check()): ?>
                        <form action="<?php echo e(route('recurring.store', $campaign->id)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                        ...
                        <div class="login-note-new">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M12 8v4m0 4h.01"/></svg>
                            Please <a href="<?php echo e(route('login')); ?>">log in</a> to set up recurring donations.
                        </div>
                        <?php endif; ?>
                    </div>
        ...
        <div class="share-card reveal-right d1">
            ...
            <div style="display:flex;flex-direction:column;gap:10px;">
                ...
                <div class="details-row">
                    ...
                    <span>
                        <?php if($campaign->start_date): ?><?php echo e(\Carbon\Carbon::parse($campaign->start_date)->format('d M Y')); ?><?php endif; ?>
                        <?php if($campaign->start_date && $campaign->end_date): ?> → <?php endif; ?>
                        <?php if($campaign->end_date): ?><?php echo e(\Carbon\Carbon::parse($campaign->end_date)->format('d M Y')); ?><?php endif; ?>
                    </span>
                </div>
                <?php endif; ?>
                <?php if($campaign->location): ?>
                <div class="details-row">
                    ...
                    <span><?php echo e($campaign->location); ?></span>
                </div>
                <?php endif; ?>
                <div class="details-row">
                    ...
                    <span>By <?php echo e($campaign->user->name ?? 'DonateBazaar'); ?></span>
                </div>
                <div class="details-row">
                    ...
                    <span><?php echo e($campaign->category->name ?? 'General'); ?></span>
                </div>
                <?php if($updates->count() > 0): ?>
                <div class="details-row">
                    ...
                    <span><?php echo e($updates->count()); ?> update<?php echo e($updates->count() !== 1 ? 's' : ''); ?> posted</span>
                </div>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="action-card reveal-right d3">
            ...
            <a href="<?php echo e(route('contact', ['campaign' => $campaign->title])); ?>" class="action-btn">
    ...
    <div class="sdb-ticker">
        ...
        <div class="sdb-ticker-text" id="sdbText">
            <?php if($latestDonation): ?>
                <strong>₹<?php echo e(number_format($latestDonation->total_amount)); ?></strong> donated by
                <?php echo e($latestDonation->is_anonymous ? 'Anonymous' : ($latestDonation->donor_name ?? 'Anonymous')); ?>

                · <?php echo e($latestDonation->created_at->diffForHumans()); ?>
...
function shareCampaign(){
    var title = '<?php echo e(addslashes($campaign->title)); ?>';
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\fundraise\resources\views/public/show.blade.php ENDPATH**/ ?>