    ...
    <div class="footer-inner">
        ...
        <div class="footer-cta">
            ...
            <div class="cta-actions">
                <a href="<?php echo e(route('all.campaigns')); ?>" class="cta-btn">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round">
                        <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/>
                    </svg>
                    Explore Campaigns
                </a>
                <a href="<?php echo e(route('campaign.create')); ?>" class="cta-btn-ghost">Start a Fundraiser <span>→</span></a>
            </div>
        </div>
        ...
        <div class="footer-grid">
            ...
            <div class="footer-col">
                ...
                <ul>
                    ...
                    <li><a href="<?php echo e(route('all.campaigns')); ?>">Campaigns</a></li>
                    <li><a href="<?php echo e(route('campaign.create')); ?>">Start Fundraiser</a></li>
                    <li><a href="<?php echo e(route('how.it.works')); ?>">How It Works</a></li>
                    <li><a href="<?php echo e(route('ddrf.index')); ?>">Disaster Relief</a></li>
                </ul>
            </div>
            ...
            <div class="footer-col">
                ...
                <ul>
                    ...
                    <li><a href="<?php echo e(route('job_posts.index')); ?>">Careers</a></li>
                    <li><a href="<?php echo e(route('blogs.index')); ?>">Blog</a></li>
                    <li><a href="<?php echo e(route('partnership')); ?>">Partnership</a></li>
                </ul>
            </div>
            ...
            <div class="newsletter-col">
                ...
                <form id="newsletter-form" action="<?php echo e(route('newsletter.subscribe')); ?>" method="POST" novalidate>
                    <?php echo csrf_field(); ?>

                    
                    <div class="nl-feedback success <?php if(session('newsletter_success')): ?> show <?php endif; ?>" id="nl-success">
                        <span>✓</span><span><?php echo e(session('newsletter_success') ?? 'You are subscribed. Welcome aboard!'); ?></span>
                    </div>
...
$message = $__bag->first($__errorArgs[0]); ?>
                        <div class="nl-feedback error show">
                            <span>!</span><span><?php echo e($message); ?></span>
                        </div>
                    <?php unset($message);
...
</html><?php /**PATH C:\xampp\htdocs\fundraise\resources\views/partials/footer.blade.php ENDPATH**/ ?>