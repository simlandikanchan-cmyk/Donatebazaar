        ...
        <div id="donors" class="testi-tab">
            <div class="testi-track"><div class="testi-slider" id="slider-donors">
                ...
                <div class="testi-card">
                    ...
                    <span class="testi-badge badge-blue">Contributed <?php echo e($i+2); ?> Times</span>
                    ...
                    <div class="testi-author">
                        <img src="https://i.pravatar.cc/40?img=<?php echo e($i); ?>" class="testi-avatar" alt="">
                        <div><div class="testi-name">Donor <?php echo e($i); ?></div><div class="testi-role">Supporter</div></div>
                    </div>
                </div>
                <?php endfor; ?>
            </div></div>
        ...
        <div id="ngos" class="testi-tab" style="display:none;">
            <div class="testi-track"><div class="testi-slider" id="slider-ngos">
                ...
                <div class="testi-card">
                    ...
                    <div class="testi-author">
                        <img src="https://i.pravatar.cc/40?img=<?php echo e($i+5); ?>" class="testi-avatar" alt="">
                        <div><div class="testi-name">NGO <?php echo e($i); ?></div><div class="testi-role">Organization</div></div>
                    </div>
                </div>
                <?php endfor; ?>
            </div></div>
        ...
        <div id="celebs" class="testi-tab" style="display:none;">
            <div class="testi-track"><div class="testi-slider" id="slider-celebs">
                ...
                <div class="testi-card">
                    ...
                    <div class="testi-author">
                        <img src="https://i.pravatar.cc/40?img=<?php echo e($i+10); ?>" class="testi-avatar" alt="">
                        <div><div class="testi-name">Celebrity <?php echo e($i); ?></div><div class="testi-role">Influencer</div></div>
                    </div>
                </div>
                <?php endfor; ?>
            </div></div>
...
<?php /**PATH C:\xampp\htdocs\fundraise\resources\views/home/sections/testimonials.blade.php ENDPATH**/ ?>