    ...
    <div class="fm-body">
        ...
        <div class="fm-section">
            ...
            <div class="custom-select" id="locationSelect">
                ...
                <div class="cs-dropdown" id="locationDropdown">
                    ...
                    ?>
                    <?php $__currentLoopData = $locations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="cs-option <?php echo e(request('location','all') === $val ? 'selected' : ''); ?>"
                         data-value="<?php echo e($val); ?>"
                         onclick="selectOption('locationDropdown','locationTrigger','locationLabel','<?php echo e($val); ?>','<?php echo e($label); ?>','filterLocation')">
                ...
                <input type="hidden" name="location" id="filterLocation" value="<?php echo e(request('location','all')); ?>">
            </div>
        ...
        <div class="fm-section">
            ...
            <div class="custom-select" id="typeSelect">
                ...
                <div class="cs-dropdown" id="typeDropdown">
                    ...
                    ?>
                    <?php $__currentLoopData = $campTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="cs-option <?php echo e(request('campaign_type','active') === $val ? 'selected' : ''); ?>"
                         data-value="<?php echo e($val); ?>"
                         onclick="selectOption('typeDropdown','typeTrigger','typeLabel','<?php echo e($val); ?>','<?php echo e($label); ?>','filterCampaignType')">
                        <div class="cs-option-check"></div>
                        <?php echo e($label); ?>
                ...
                <input type="hidden" name="campaign_type" id="filterCampaignType" value="<?php echo e(request('campaign_type','active')); ?>">
            </div>
        </div>
        ...
        <div class="fm-section">
            ...
            <div class="type-chips" id="fundingChips">
                <?php $__currentLoopData = ['any'=>'Any','lt25'=>'Under 25%','25to75'=>'25% – 75%','gt75'=>'75%+','100'=>'Fully Funded']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <span class="type-chip <?php echo e(request('funding','any') === $val ? 'selected' : ''); ?>"
                      onclick="selectChip(this,'fundingChips','filterFunding','<?php echo e($val); ?>')"
                      data-value="<?php echo e($val); ?>"><?php echo e($label); ?></span>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
            <input type="hidden" id="filterFunding" value="<?php echo e(request('funding','any')); ?>">
        </div>
        ...
        <div class="fm-section">
            ...
            <div class="type-chips" id="categoryChips">
                <span class="type-chip <?php echo e(!request('category') ? 'selected' : ''); ?>"
                      onclick="selectChip(this,'categoryChips','filterCategory','')"
                      data-value="">All</span>
                <?php $__currentLoopData = $categories ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <span class="type-chip <?php echo e(request('category') === $cat->slug ? 'selected' : ''); ?>"
                      onclick="selectChip(this,'categoryChips','filterCategory','<?php echo e($cat->slug); ?>')"
                      data-value="<?php echo e($cat->slug); ?>"><?php echo e($cat->name); ?></span>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
            <input type="hidden" id="filterCategory" value="<?php echo e(request('category','')); ?>">
        </div>
...
<div class="hero">
    <div class="hero-bg">
        <img src="<?php echo e(asset('images/about.jpg')); ?>" alt="All Campaigns" loading="eager">
    </div>
    ...
    <div class="hero-inner">
        <div class="hero-content">
            <div class="hero-pill">
                ...
                <?php echo e($campaigns->total() ?? $campaigns->count()); ?>+ Verified Campaigns Live
            </div>
            ...
            <form method="GET" action="<?php echo e(url()->current()); ?>" class="hero-search">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.35-4.35"/></svg>
                <input type="text" name="search" placeholder="Search campaigns, causes, NGOs…" value="<?php echo e(request('search')); ?>">
...
<div class="marquee-band">
    <div class="marquee-inner">
        <div class="marquee-row">
            <?php $mItems = ['Medical · Education · Disaster · Animal · Child Welfare · Environment', 'Verified by DonateBazaar', 'RBI-Compliant Payments', '80G Tax Benefits', '24×7 Donor Support', '100% Transparent', 'Pan-India Coverage']; ?>
            <?php for($r=0;$r<3;$r++): ?>
                <?php $__currentLoopData = $mItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <span class="m-item"><span class="m-dot"></span><?php echo e($mi); ?></span>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php endfor; ?>
        </div>
    </div>
...
<div class="toolbar-section">
    <div class="toolbar-inner">
        ...
        <div class="cat-chips">
            <a href="<?php echo e(url()->current()); ?>" class="cat-chip <?php echo e(!request('category') ? 'active' : ''); ?>">All</a>
            <?php $__currentLoopData = $categories ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(url()->current()); ?>?category=<?php echo e($category->slug); ?><?php echo e(request('search') ? '&search='.urlencode(request('search')) : ''); ?><?php echo e(request('sort') ? '&sort='.request('sort') : ''); ?>"
                   class="cat-chip <?php echo e(request('category') === $category->slug ? 'active' : ''); ?>">
                    <?php echo e($category->name); ?>

                    <span style="font-size:10px;opacity:.7;margin-left:3px">(<?php echo e($category->campaigns_count ?? 0); ?>)</span>
                </a>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
        ...
        <div class="toolbar-right">
            <span class="results-count"><?php echo e($campaigns->total() ?? $campaigns->count()); ?> campaigns</span>
            ...
            <form method="GET" action="<?php echo e(url()->current()); ?>" id="sortForm">
                ...
                <select name="sort" class="sort-select" onchange="document.getElementById('sortForm').submit()">
                    ...
                    <option value="ending_soon" <?php echo e(request('sort') === 'ending_soon'          ? 'selected' : ''); ?>>Ending Soon</option>
                    <option value="most_funded" <?php echo e(request('sort') === 'most_funded'          ? 'selected' : ''); ?>>Most Funded</option>
                    <option value="most_donors" <?php echo e(request('sort') === 'most_donors'          ? 'selected' : ''); ?>>Most Donors</option>
                </select>
            </form>
            ...
            <aside class="sidebar">
                ...
                <div class="filter-card">
                    ...
                    <label class="filter-checkbox">
                        <input type="checkbox" name="funding" value="any" <?php echo e(!request('funding') || request('funding') === 'any' ? 'checked' : ''); ?> onchange="applySidebarFilters()">
                        <span class="filter-checkbox-label">Any progress</span>
                        <span class="filter-checkbox-count"><?php echo e($campaigns->total() ?? ''); ?></span>
                    </label>
                    <div class="filter-divider"></div>
                    <label class="filter-checkbox">
                        <input type="checkbox" name="funding" value="lt25" <?php echo e(request('funding') === 'lt25' ? 'checked' : ''); ?> onchange="applySidebarFilters()">
                        <span class="filter-checkbox-label">Under 25% funded</span>
                    </label>
                    <label class="filter-checkbox">
                        <input type="checkbox" name="funding" value="25to75" <?php echo e(request('funding') === '25to75' ? 'checked' : ''); ?> onchange="applySidebarFilters()">
                        <span class="filter-checkbox-label">25% – 75% funded</span>
                    </label>
                    <label class="filter-checkbox">
                        <input type="checkbox" name="funding" value="gt75" <?php echo e(request('funding') === 'gt75' ? 'checked' : ''); ?> onchange="applySidebarFilters()">
                        <span class="filter-checkbox-label">75%+ funded</span>
                    </label>
                    <label class="filter-checkbox">
                        <input type="checkbox" name="funding" value="100" <?php echo e(request('funding') === '100' ? 'checked' : ''); ?> onchange="applySidebarFilters()">
                ...
                <div class="filter-card">
                    ...
                    <?php $__currentLoopData = $categories ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <label class="filter-checkbox">
                        <input type="checkbox" name="cat_sidebar" value="<?php echo e($cat->slug); ?>" onchange="applySidebarFilters()" <?php echo e(request('category') === $cat->slug ? 'checked' : ''); ?>>
                        <span class="filter-checkbox-label"><?php echo e($cat->name); ?></span>
                        <span class="filter-checkbox-count"><?php echo e($cat->campaigns_count ?? ''); ?></span>
                    </label>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                ...
                <div class="filter-card" style="background:linear-gradient(135deg,rgba(99,102,241,.06),rgba(139,92,246,.06));border-color:rgba(99,102,241,.18)">
                    ...
                    <a href="<?php echo e(url('/about')); ?>" style="display:inline-flex;align-items:center;gap:5px;font-size:12px;color:var(--accent);font-weight:600;margin-top:12px">
                        Learn more
...
<?php $__empty_1 = true; $__currentLoopData = $campaigns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $campaign): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
    ...
    ?>
                    ...
                    <div class="spotlight-card reveal">
                        <div class="spotlight-body">
                            ...
                            <div class="spotlight-title"><?php echo e($campaign->title); ?></div>
                            <div class="spotlight-excerpt"><?php echo e(Str::limit(strip_tags($campaign->description), 160)); ?></div>
                            <div class="spotlight-stats">
                                <div>
                                    <span class="spotlight-stat-val">₹<?php echo e(number_format($raised)); ?></span>
                                    <div class="spotlight-stat-lbl">Raised so far</div>
                                </div>
                                <div>
                                    <span class="spotlight-stat-val"><?php echo e(number_format($donors)); ?></span>
                                    <div class="spotlight-stat-lbl">Donors</div>
                                </div>
                                <?php if($daysLeft !== null): ?>
                                <div>
                                    <span class="spotlight-stat-val"><?php echo e($daysLeft); ?></span>
                                    <div class="spotlight-stat-lbl">Days left</div>
                                </div>
                                <?php endif; ?>
                            </div>
                            <div class="spotlight-progress-track">
                                <div class="spotlight-progress-fill" style="width:<?php echo e($percentage); ?>%"></div>
                            </div>
                            <div style="font-size:12px;color:rgba(255,255,255,.6);font-family:var(--font-mono);margin-bottom:24px">
                                <?php echo e($percentage); ?>% of ₹<?php echo e(number_format($goal)); ?> goal
                            </div>
                            <a href="<?php echo e(route('campaign.public', [$categorySlug, $campaign->slug])); ?>" class="spotlight-btn">
                                Donate Now
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M5 12h14M12 5l7 7-7 7"/></svg>
                            </a>
                        </div>
                        <div class="spotlight-img">
                            <img src="<?php echo e(asset('storage/' . $campaign->cover_image)); ?>" alt="<?php echo e($campaign->title); ?>" loading="lazy">
                        </div>
                    </div>
                    <?php else: ?>
                    
                    <div class="camp-card reveal d<?php echo e(($index % 3) + 1); ?>"
                         data-cat="<?php echo e($campaign->category->slug ?? 'uncategorized'); ?>"
                         data-pct="<?php echo e($percentage); ?>">
                        <div class="camp-img">
                            <img loading="lazy" src="<?php echo e(asset('storage/' . $campaign->cover_image)); ?>" alt="<?php echo e($campaign->title); ?>">
                            <div class="camp-badge-wrap">
                                <span class="camp-cat-badge"><?php echo e($campaign->category->name ?? 'General'); ?></span>
                            ...
                            <div class="camp-urgency">
                                ...
                                <span class="camp-urgency-text"><?php echo e($daysLeft === 0 ? 'Last day!' : $daysLeft . ' days left'); ?></span>
                            </div>
                            <?php endif; ?>
                        </div>
                        <div class="camp-body">
                            <h3 class="camp-title"><?php echo e($campaign->title); ?></h3>
                            <p class="camp-excerpt"><?php echo e(Str::limit(strip_tags($campaign->description), 100)); ?></p>

                            <div class="camp-progress-wrap">
                                <div class="camp-progress-track">
                                    <div class="camp-progress-fill" style="width:<?php echo e($percentage); ?>%"></div>
                                </div>
                                <div class="camp-meta-row">
                                    <span class="camp-raised">₹<?php echo e(number_format($raised)); ?></span>
                                    <span class="camp-pct"><?php echo e($percentage); ?>%</span>
                                </div>
                                <div class="camp-goal">of ₹<?php echo e(number_format($goal)); ?> goal</div>
                            </div>
                            ...
                            <div class="camp-info-strip">
                                ...
                                <div class="camp-info-item">
                                    ...
                                    <?php echo e($daysLeft > 0 ? $daysLeft.'d left' : 'Ends today'); ?>
                            ...
                            <a href="<?php echo e(route('campaign.public', [$categorySlug, $campaign->slug])); ?>" class="camp-btn">
                                Donate Now
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M5 12h14M12 5l7 7-7 7"/></svg>
                            </a>
                        </div>
                    ...
                    <div class="empty-state">
                        ...
                        <a href="<?php echo e(url()->current()); ?>" class="btn btn-accent" style="margin:24px auto 0;width:fit-content">
                            View All Campaigns
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M5 12h14M12 5l7 7-7 7"/></svg>
                        </a>
                    </div>
 ...
 <?php if($campaigns->hasPages()): ?>
    <div class="pagination-wrap">
        ...
        <?php else: ?>
            <a href="<?php echo e($campaigns->previousPageUrl()); ?>" class="page-btn">‹</a>
        <?php endif; ?>

        
        <?php $__currentLoopData = $campaigns->links()->elements[0] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <?php if($campaigns->hasMorePages()): ?>
            <a href="<?php echo e($campaigns->nextPageUrl()); ?>" class="page-btn">›</a>
        <?php else: ?>
            <span class="page-btn disabled">›</span>
        <?php endif; ?>
...
<section class="cta-section">
    <div class="cta-bg-img"><img src="<?php echo e(asset('images/banner2.jpeg')); ?>" alt=""></div>
    <div class="cta-inner">
        ...
        <div class="cta-btns reveal d3">
            ...
            <a href="<?php echo e(url('/about')); ?>" class="btn btn-white" style="font-size:15px;padding:15px 34px">
                How It Works
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M5 12h14M12 5l7 7-7 7"/></svg>
            </a>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\fundraise\resources\views/campaigns/all-campaigns.blade.php ENDPATH**/ ?>